...
const MODULES: ModuleItem[] = [
  {
    icon: "people-outline",
    label: "Customers",
    description: "Accounts & credit limits",
    route: "/(tabs)/customers/index",
    color: "#3B82F6",
    bg: "#EFF6FF",
  },
  {
  ...
  },
  {
    icon: "cart-outline",
    label: "Sales Orders",
    description: "Order-to-cash pipeline",
    route: "/(tabs)/sales-orders/index",
    color: "#10B981",
    bg: "#ECFDF5",
  },
  {
