          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Link href={`/vendors/${po.vendorId}`} className="text-primary hover:underline">
                  {po.vendor.name}
                </Link>
              </div>
              <div>
                <p className="text-sm font-medium text-muted-foreground">Total Amount</p>
                <p className="font-bold">${po.totalAmount.toFixed(2)}</p>
              </div>
              <div>
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className="text-right font-bold">${po.totalAmount.toFixed(2)}</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </CardContent>
