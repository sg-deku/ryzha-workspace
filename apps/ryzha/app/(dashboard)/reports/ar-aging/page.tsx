...
export default async function ARAgingPage() {
  ...
  const byBucket: Record<string, { invoices: typeof openInvoices; total: number }> = {}
  ...
  for (const inv of openInvoices) {
    ...
    byBucket[bucket].total += inv.total
  }

  const grandTotal = openInvoices.reduce((s, i) => s + i.total, 0)
