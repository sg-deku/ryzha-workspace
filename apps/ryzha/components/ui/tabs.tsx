...
const Tabs = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Root> & { className?: string; children?: React.ReactNode }
>(({ className, ...props }, ref) => {
  const Root = TabsPrimitive.Root as React.ComponentType<AnyProps>
  return <Root ref={ref} className={className} {...props} />
})
...
>(({ className, ...props }, ref) => {
  const List = TabsPrimitive.List as React.ComponentType<AnyProps>
  return (
    <List
      ref={ref}
      className={cn(
